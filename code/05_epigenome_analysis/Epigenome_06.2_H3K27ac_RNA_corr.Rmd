...
HERE, RUN THE SHELL SCRIPT "Epigenome_06.3_CTCF_enh_intersect_bedtools.sh"
...
ggsave("results/AppendixFigS3_p_r.pdf", width = 40, height=48, units="cm", limitsize=FALSE)  
...
ggsave("results/FigEV4F.pdf", width = 20, height=10, units="cm")
...
ggscatter(tead1, x = "H3K27ac", y="Gene_expression", add = "reg.line",
    ...
    theme(axis.text = element_text(size=14),
          strip.background = element_rect(colour="black",
                                        fill="white")) +
    facet_wrap(vars(symbol, loc_ID), scales="free", ncol=3) 
#ggsave("results/Fig4B.pdf", width = 20, height=12, units="cm")
```
