...
write.table(K27_GE_joined, "Supplemental_tables/SupplementalTable_initial_EREGs.txt", quote=F, row.names=F, sep="\t")
```
...
#write.table(K27_GE_long_group, "Supplemental_tables/SupplementalTable_Initial_EREG_genes_corr.txt", quote=F, row.names=F, sep="\t")
...
#write.table(K27_GE_long_group_plot_pearson, "Supplemental_tables/SupplementalTable_step2_EREG_genes_corr_0.75pearson.txt", quote=F, row.names=F, sep="\t")
...
#write.table(K27_GE_long_rev_insect, "Supplemental_tables/SupplementalTable_step3_EREG_genes_corr_0.75pearson_reverted.txt", quote=F, row.names=F, sep="\t")
```
...
write.table(K27_GE_long_group_plot_filt, "Supplemental_tables/SupplementalTable_step4_EREG_genes_corr_rev_CTCF.txt", row.names = F,  quote = F, sep="\t")
