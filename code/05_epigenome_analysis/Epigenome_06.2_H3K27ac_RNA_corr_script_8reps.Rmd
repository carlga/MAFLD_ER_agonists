...
#write.table(K27_GE_long_group_plot_pearson, "Supplementary_tables/SupplementaryTable_step2_ESEG_genes_corr_0.75pearson.txt", quote=F, row.names=F, sep="\t")
...
#write.table(K27_GE_long_rev_insect, "Supplementary_tables/SupplementaryTable_step3_ESEG_genes_corr_0.75pearson_reverted.txt", quote=F, row.names=F, sep="\t")
```
