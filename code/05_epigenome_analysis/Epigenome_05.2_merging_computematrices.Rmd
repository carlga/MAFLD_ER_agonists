...
enhancer_plot_profile <- enhancer_plot_profile %>% rename("locid"=V4)

joined_matrix.enhancers <- inner_join(enhancer_plot_profile[,1:406], inner_join(CD.merged, inner_join(HFD.merged, inner_join(DPN.merged, inner_join(DIP.merged, inner_join(E2.merged, PPT.merged, by=c("V1", "V2", "V3", "locid", "V5", "V6")))))))
