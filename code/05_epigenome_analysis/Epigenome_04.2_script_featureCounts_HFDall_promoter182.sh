...
#SBATCH --output=220630_FeatureCounts_prom.out
#SBATCH --error=220630_FeatureCounts_prom.err
...
featureCounts \
	...
	-F SAF \
        -O \
        -C \
        -a ${SAF_PATH}/220629_allDB_promoters_182_shortestDistance.saf  \
        -o ${OUTPUT_PATH}/220630_diffbind_HFDall_promoters182_H3K27ac.readCount \
        ${BAM_PATH}/*H3K27ac*MkDup.bam \
        &> ${OUTPUT_PATH}/220630_diffbind_HFDall_promoters182_H3K27ac.readCount.log
