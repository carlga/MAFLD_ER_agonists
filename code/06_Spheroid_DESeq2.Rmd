...
write.table(export_TPM_normTables_single, "results/spheroid_TPM_norm_counts_n.txt", sep="\t", quote=F, row.names = F)
write.table(export_TPM_normTables_mean, "results/spheroid_TPM_norm_counts_mean_n.txt", sep="\t", quote=F, row.names = F)
```
